      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-16">
          <div className="lg:col-span-2">
            <Link href="/">
              <img src={logoImg} alt="Atlas Corporate Services" className="h-10 w-auto mb-6 cursor-pointer object-contain" />
            </Link>
            ...
            <div className="flex items-center gap-3 mt-6">
              {socials.map((s) => (
                <a
                  ...
                  aria-label={s.name}
                  className="w-8 h-8 rounded-full bg-slate-100 hover:bg-[#142E36] text-slate-500 hover:text-white flex items-center justify-center transition-colors duration-200"
                >
                  {s.icon}
                </a>
              ))}
          ...
          <div className="flex items-center gap-3">
            {socials.map((s) => (
              <a
                ...
                rel="noopener noreferrer"
                aria-label={s.name}
                className="w-7 h-7 rounded-full bg-slate-100 hover:bg-[#142E36] text-slate-400 hover:text-white flex items-center justify-center transition-colors duration-200"
              >
                {s.icon}
              </a>
            ))}
