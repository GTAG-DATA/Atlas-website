...
const routes = [
  ...
  { path: '/insights/prescribed-company-handbook', file: 'insights/prescribed-company-handbook/index.html',
  ...
  { path: '/insights/economic-substance-guide', file: 'insights/economic-substance-guide/index.html',
  ...
  { path: '/insights/uae-corporate-tax-overview', file: 'insights/uae-corporate-tax-overview/index.html',
